// Phosphor Icons extracted from zchry.org
...
// Project-specific icons (Phosphor)
...
export function GitBranchIcon({ className }: { className?: string }) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor">
      <path d="M208,80a32,32,0,1,0-40,31v17a8,8,0,0,1-8,8H96a24,24,0,0,0-24-22.4V111a32,32,0,1,0-16,0v4.64A24,24,0,0,0,80,136v24a24,24,0,0,0,22.4,24H145a32,32,0,1,0,16-1.28V159.4A40,40,0,0,0,168,128V111A32.06,32.06,0,0,0,208,80ZM48,80a16,16,0,1,1,16,16A16,16,0,0,1,48,80Zm112,96a16,16,0,1,1-16-16A16,16,0,0,1,160,176ZM176,80a16,16,0,1,1,16,16A16,16,0,0,1,176,80Z"/>
    </svg>
  );
}
