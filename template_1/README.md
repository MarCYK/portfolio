...
1. **Clone this repo**
   ```bash
   git clone https://github.com/JCodesMore/fine-thought.git fine-thought
   cd fine-thought
   ```
...
[![Star History Chart](https://api.star-history.com/svg?repos=JCodesMore/fine-thought&type=Date)](https://star-history.com/#JCodesMore/fine-thought&Date)
